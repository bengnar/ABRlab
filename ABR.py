...
basedir = '/Users/User/Desktop/USB/Manipulations/ABR/FMRP Mouse Data/txt'
# basedir = '/'
...
def manual_threshold_all():
	...
	fnames = glob.glob(os.path.join(basedir, 'data', '*.npz'))
...
def convert_all():
	...
	fnames = glob.glob(os.path.join(basedir, '*.txt'))
